...
# Initial screen
print("Welcome to " + green + "emailGenarator-By-darkboss1" + reset + "!\nDeveloped by " + blue + "White Hat Hacker (@darkboss1)" + reset + ".\nFor feedback and/or questions send me a private message on " + blue + "https://serialkey.top/" + reset)
print("")
